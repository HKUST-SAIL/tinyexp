...
def print_hyp(hypothesis, hyp_name):
    ...
    print(f"{hyp_name}: score={hypothesis['score']}, translation={h_translation:.2f}m, " f"rotation={h_angle:.1f}deg.")
...
def estimated_alignment(
    ...
    if len(ransac_hypotheses) == 0:
        print("Did not fine a single valid RANSAC hypothesis, abort alignment estimation.")
        return None, 1
