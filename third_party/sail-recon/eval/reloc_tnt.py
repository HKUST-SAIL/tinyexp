...
import numpy as np
import torch
from eval.datasets.tnt import TnTDataset
...
def parse_args():
    ...
    parser.add_argument(
        "--dataset_root",
        type=str,
        default="/horizon-bucket/saturn_v_4dlabel/008_Simulation/001_users/junyuan.deng/evaluation_datasets/TankandTemple_ORI/keyframes",
